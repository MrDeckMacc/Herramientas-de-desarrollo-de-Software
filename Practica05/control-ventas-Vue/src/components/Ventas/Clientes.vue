          ...
          <v-dialog v-model="dialog" max-width="500px">
            ...
            <v-card>
              ...
              <v-card-actions>
                ...
                <v-btn color="green darken-1" text @click="Grabar">
                  Grabar
                </v-btn>
              </v-card-actions>
            </v-card>
  ...
  export default {
    data: () => ({
      ...
      validar() {
        ...
        if(this.nombrePersona.length< 3 || this.nombrePersona.length >150)
    ...
    methods: {
      ...
      {
          let Lista = this;
          axios.get('https://localhost:44338/api/Personas/ListarCliente').then(function(response)
          {
