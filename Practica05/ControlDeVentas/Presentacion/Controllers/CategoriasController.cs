...
namespace Presentacion.Controllers
{
    ...
    public class CategoriasController : ControllerBase
    {
        ...
        // PUT: api/Categorias/DesactivarCategoria
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPut("[action]/{id}")]
        ...
        // PUT: api/Categorias/ActivarCategoria
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPut("[action]/{id}")]
        ...
        // GET: api/Categorias/SeleccionarCategoria
        [HttpGet("[action]")]
        public async Task<IEnumerable<SeleccionarArticuloViewModel>> SeleccionarCategoria()
        {
